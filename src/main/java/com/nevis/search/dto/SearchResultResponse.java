...
/**
 * One search hit. Tagged union: {@code type} discriminates, and exactly one of {@code client} or
 * {@code document} is populated; the other is omitted from the JSON.
 */
...
public record SearchResultResponse(
        ...
        @Schema(description = "Relevance, 0-1. Trigram similarity for clients, vector distance "
                + "for documents, normalised so the two are comparable.",
